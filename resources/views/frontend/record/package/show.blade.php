...
@section('title', app_name() . ' | ' . 'Package' )
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{ html()->form('POST', route('frontend.record.package.reserve', $package))->attribute("enctype","multipart/form-data")->class('form-horizontal')->open() }}
                            ...
                            <div class="card p-4">
                                ...
                                <div class="row">
                                    <div class="col col-md-6">
                                        <button type="button" class="btn btn-warning btn-sm "  id="btn-show-package">
                                            Show Package
                                        </button>
                                    </div>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col">
                            <a href="{{route('frontend.record.package.index')}}" class="btn btn-info btn-sm">Go Back</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $("#btn-show-package").click(function(e){

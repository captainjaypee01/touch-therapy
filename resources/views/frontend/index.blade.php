                                ...
                                <div id="carouselServices" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner text-secondary">
                                        ...
                                        <div class="carousel-item {{ ($loop->iteration - 1) == 0 ? 'active' : ''}}">
                                            <img src="{{ $service->image_location ? url('uploads/' . $service->location) : asset('img/frontend/ortiz-clinic-logo.png') }}"  height="250px" class="d-block w-100" alt="...">
                            ...
                            <div class="bd-example">
                                <div id="carouselProducts" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner text-secondary">
                                        @foreach($products as $product)
                                        <div class="carousel-item {{ ($loop->iteration - 1) == 0 ? 'active' : ''}}">
                                            <img src="{{ $product->image_location ? url('uploads/' . $service->location) : asset('img/frontend/ortiz-clinic-logo.png') }}"  height="250px" class="d-block w-100" alt="...">
                                            <div class="carousel-caption d-none d-md-block text-body">
